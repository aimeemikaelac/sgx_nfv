...
App_Cpp_Files := untrusted/App.cpp #$(wildcard App/Edger8rSyntax/*.cpp) $(wildcard App/TrustedLibrary/*.cpp)
...
$(UNTRUSTED_DIR)/Enclave1_u.c: $(SGX_EDGER8R) trusted/Enclave1.edl
	@cd $(UNTRUSTED_DIR) && $(SGX_EDGER8R) --untrusted ../trusted/Enclave1.edl --search-path ../trusted --search-path $(SGX_SDK)/include
	@echo "GEN  =>  $@"
...
clean:
	@rm -f App  $(App_Cpp_Objects) $(UNTRUSTED_DIR)/Enclave1_u.* 

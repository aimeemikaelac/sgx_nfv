...
BasicElementSHA256::BasicElementSHA256(){
...
/**
  ...
  *   an error code
 **/
long int BasicElementSHA256::sendData(unsigned char *data, unsigned int length){
...
CLICK_ENDDECLS
EXPORT_ELEMENT(BasicElementSHA256)

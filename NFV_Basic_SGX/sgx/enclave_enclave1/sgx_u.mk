...
App_Include_Paths := -IInclude -I$(UNTRUSTED_DIR) -I$(SGX_SDK)/include -I/usr/local/include
...
App_Link_Flags := $(SGX_COMMON_CFLAGS) -L$(SGX_LIBRARY_PATH) -l$(Urts_Library_Name) -lpthread -lclick 
...
$(UNTRUSTED_DIR)/enclave1_u.c: $(SGX_EDGER8R) trusted/enclave1.edl
	@cd $(UNTRUSTED_DIR) && pwd && $(SGX_EDGER8R) --untrusted ../trusted/enclave1.edl --search-path ../trusted --search-path $(SGX_SDK)/include
	@echo "GEN  =>  $@"
